...
class cDBFactory{
	 ...
	 *
	 * @param array|null $arrConfig database configuration (required on first call)
	 ...
	 */
	public static function getInstance($arrConfig = null){
	 ...
	 */
	private static function getDBObject($sDbType){
		$objDb = null;
