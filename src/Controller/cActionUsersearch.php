 ...
 */
class cActionUsersearch extends cAction{
	...
	public function performAction(): void{
		...
		if(empty($sUserName)){
			...
			$this->m_objTemplate->addData($this->getContextDataArray(array("previd"	=>$objUserSearchList->getPrevPageId(),
																	   		"nextid"	=>$objUserSearchList->getNextPageId(),
																			"username"	=>urlencode($sUserName))));

			$this->m_objTemplate->addData(array("user"=>$objUserSearchList->getDataArray()));
		}
