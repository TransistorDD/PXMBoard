...
class cAdminActionUserlist extends cAdminAction{
	...
	public function performAction(): void{
		...
		else $this->m_sOutput .= "<th><a href=\"pxmboard.php?mode=admuserlist&sort=regi&direction=$sSortDirection&filter=$iUserStateFilter\">date of registration</a></th>";
		...
		else $this->m_sOutput .= "<th><a href=\"pxmboard.php?mode=admuserlist&sort=profile&direction=$sSortDirection&filter=$iUserStateFilter\">last profile change</a></th>";
		if($sSortMode=="online"){
		...
		else $this->m_sOutput .= "<th><a href=\"pxmboard.php?mode=admuserlist&sort=online&direction=$sSortDirection&filter=$iUserStateFilter\">last online</a></th>";
		...
		else $this->m_sOutput .= "<th><a href=\"pxmboard.php?mode=admuserlist&sort=posts&direction=$sSortDirection&filter=$iUserStateFilter\">posts</a></th>";
