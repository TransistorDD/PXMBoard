 ...
 */
class cActionMessagedraftlist extends cAction{
	...
	public function performAction(): void{
		...
		$this->m_objTemplate->addData($this->getContextDataArray(array("previd"	=>$objDraftList->getPrevPageId(),
																				"nextid"	=>$objDraftList->getNextPageId())));
		$this->m_objTemplate->addData(array("drafts"=>$objDraftList->getDataArray()));
	}
}
?>
