...
class cActionPrivatemessagelist extends cAction{
	...
	public function performAction(): void{
		...
		$this->m_objTemplate->addData($this->getContextDataArray(array("previd"	=>$objPrivateMessageList->getPrevPageId(),
																				"nextid"	=>$objPrivateMessageList->getNextPageId(),
																				"type"		=>$sType)));
		$this->m_objTemplate->addData(array("msg"=>$objPrivateMessageList->getDataArray()));
	}
}
?>