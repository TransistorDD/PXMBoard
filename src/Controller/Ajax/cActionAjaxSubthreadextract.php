...
/**
 * Ajax-Action: Extract a subthread
 *
 * @author Torsten Rentsch <forum@torsten-rentsch.de>
 * @copyright Torsten Rentsch 2001 - 2026
 */
class cActionAjaxSubthreadextract extends cActionAjax {
	...
	/**
	 * Perform action - extract a subthread via Ajax
	 *
	 * @return void
	 */
	public function performAction(): void {
		...
		// Success response
		$this->_setJsonSuccess(eSuccessMessage::SUBTHREAD_EXTRACTED);
	}
}
?>
