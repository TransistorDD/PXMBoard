...
use PXMBoard\Model\cMessageNotificationList;
 ...
 */
class cActionMessagenotificationlist extends cPublicAction
{
    /**
    ...
    public function performAction(): void
    {
        ...
        $this->m_objTemplate->addData(['notifications' => $objNotificationList->getDataArray()]);
    }
}
