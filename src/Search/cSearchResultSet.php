...
{
    /**
     * @var array<mixed> Array of result items with structure: ['id' => int, 'score' => float, 'timestamp' => int]
     */
     ...
     * Constructor
     *
     * @param array<mixed> $arrResults Array of result items
     ...
     *
     * @return array<mixed> Array of result items with keys: id, score, timestamp
     */
