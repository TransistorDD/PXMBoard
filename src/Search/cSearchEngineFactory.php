...
class cSearchEngineFactory {
	 ...
	 *
	 * @param array|null $arrConfig Search engine configuration (required on first call, must contain 'type' key, e.g. "MySql", "ElasticSearch")
	 ...
	 * @param array $arrConfig Engine-specific configuration
