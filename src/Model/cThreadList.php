...
class cThreadList extends cScrollList{
	 ...
	 * @param integer $iUserId user id (for read tracking, 0 for guests)
	 * @return void
	 */
	public function __construct($iBoardId,$sSortMode,$iTimeSpan,$iUserId = 0){
	 ...
	 */
	public function getDataArray($iTimeOffset = 0,$sDateFormat = "",$iLastOnlineTimestamp = 0){
