...
class cBoardMessage extends cMessage{
	 ...
	 */
	public function loadDataById($iMessageId,$iBoardId = -1){
	 ...
	 */
	public function insertData($iParentId,$iAutoClose){
	 ...
	 *
	 * @return boolean notify on reply
	 */
	 ...
	 *
	 * @param boolean $bNotifyOnReply notify on reply
	 * @return void
	 */
	 ...
	 * is message read?
	 *
	 * @return boolean is message read
	 */
	 ...
	 *
	 * @param boolean $bIsRead is message read
	 * @return void
	 */
	 ...
	 *
	 * @return boolean true if message is a draft
	 */
	 ...
	 *
	 * @return boolean true if message is published
	 */
	 ...
	 *
	 * @return boolean true if message is deleted
	 */
	...
	public function getDataArray($iTimeOffset,$sDateFormat,$iLastOnlineTimestamp,$sSubjectQuotePrefix = "",$objParser = null){
		...
		return array_merge(cMessage::getDataArray($iTimeOffset,$sDateFormat,$iLastOnlineTimestamp,$sSubjectQuotePrefix,$objParser),
						   array("notify_on_reply"	=>	$this->m_bNotifyOnReply,
