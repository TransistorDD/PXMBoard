 ...
 * @param array  $arrValues Current form values
 * @param array  $arrErrors Current validation errors
 ...
 * @param array  $arrTemplates   Template types
 * @param array  $arrSearch      Search engine config
